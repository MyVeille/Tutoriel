...
- CIP UdeS : veim2705
- ID GitHub : MyVeille
- Thème du tutoriel : MongoDB 
- URL du tutoriel : https://github.com/MyVeille/Tutoriel
...
- [X] E3 - Les exemples sont parfois pertinents ou utiles, mais ne sont pas toujours liés à la manipulation des données d'affaires.
...
- [X] G1 - La qualité de la langue, la présentation visuelle, la qualité des références et le respect du droit d'auteur sont exceptionnels.
...
|Qualité générale, langue, présentation, référence, etc.|100.0|
|**Total** | **91.0**|
